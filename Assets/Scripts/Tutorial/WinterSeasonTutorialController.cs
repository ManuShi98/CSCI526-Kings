...
public class WinterSeasonTutorialController : MonoBehaviour, IEventHandler<SeasonChangeEvent>, IEventHandler<CollidersClickEvent>, IEventHandler<GameStartEvent>
{
    private int step;
    ...
    {
        if (step == 1 && eventData.ChangedSeason == Season.WINTER)
        {
            step = 2;
